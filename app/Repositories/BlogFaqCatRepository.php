 ...
 */
class BlogFaqCatRepository extends BaseRepository implements BlogFaqCatContract
{
    use UploadAble;

    /**
     * BlogCategoryRepository constructor.
     * @param ArtcileFaqCategory $model
     */
    public function __construct(ArtcileFaqCategory $model)
    {
    ...
    public function createCategory(array $params)
    {
        try {
            ...
            $category = new ArtcileFaqCategory;
    ...
    {
        $categories = ArtcileFaqCategory::where('id',$id)->get();

        return $categories;
    }
    public function getSearchCategories(string $term)
    {
        return ArtcileFaqCategory::where([['title', 'LIKE', '%' . $term . '%']])->get();
    }
}
