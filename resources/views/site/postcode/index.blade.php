                        ...
                        <div class="row">
                            ...
                            <div class="col col-md fcontrol position-relative">
                                <div class="form-floating">
                                    <input type="search" name="title" class="form-control pl-3" placeholder="Search by keyword...">
                        ...
                        <div class="card blogCart border-0">
                            ...
                            <div class="card-body">
                                <div class="card-body-top">
                                    <h5 class="card-title m-0"><a href="{!! URL::to('article-details/'.$blog->id.'/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $blog->title))) !!}" class="location_btn">{{$blog->title}}</a></h5>
                                </div>
                                <div class="card-body-bottom">
                                    <p>{!! $blog->content !!}</p>
                                    <a href="{!! URL::to('article-details/'.$blog->id.'/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $blog->title))) !!}" class="readMoreBtn">Read Article <i class="fas fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    success: function(result) {
                        ...
                        if (result.error === false) {
                            ...
                            $.each(result.data, (key, value) => {
                                content += `<a class="dropdown-item" href="javascript: void(0)" onclick="fetchCode(${value.pin})">${value.state}, ${value.pin}</a>`;
                            })
                            content += `</div>`;
