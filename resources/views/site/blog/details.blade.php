                ...
                <div class="col-12">
                    <div class="artiledetails_banner_text">
                        <div class="article_badge_wrap">
                            ...
                            <span class="badge">{{$blog->pincodedetails? $blog->pincodedetails->pin : ''}}</span>
                        </div>
                        <h1>{{ $blog->title }}</h1>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="card blogCart border-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-body-bottom">
                                        ...
                                        <a href="{!! URL::to('article-details/'.$blog->id.'/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $blog->title))) !!}" class="readMoreBtn">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
