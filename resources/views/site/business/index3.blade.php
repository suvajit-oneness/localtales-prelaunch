                            ...
                            <div class="card directoryCard border-0 v3card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="review">
                                        ...
                                        <small>{{$business->total_reviews}} Reviews</small>
                                    </p>
                                    <p><i class="fas fa-map-marker-alt"></i> {!! $business->address !!}</p>
                                    <input type="hidden" id="googlemapaddress" value="">
                                    <div>
                                        <div>
                                            <a href="#" class="g_l_icon"><i class="fas fa-phone-alt"></i>{{$business->mobile}}</a>
                                        </div>
                      ...
                      <li>
                          ...
                          <div class="list_content_wrap">
                                ...
                                <div class="location_meta">
                                    ...
                                    <div class="v3readmore">
                                        <a href="{!! URL::to('directory-details/'.$business->id.'/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $business->name))) !!}">View Details<i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
...
<script type="text/javascript">
	...
	foreach($businesses as $business){
	    ...
	    $img = "https://maps.googleapis.com/maps/api/streetview?size=640x640&location=".$business->latitude.",".$business->longitude."&fov=120&heading=0&key=AIzaSyDPuZ9AcP4PHUBgbUsT6PdCRUUkyczJ66I";
