                ...
                <form action="{{ route('admin.dircategory.store') }}" method="POST" role="form" enctype="multipart/form-data">@csrf
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('short_content') is-invalid @enderror" name="short_content" id="short_content" cols="30" rows="10">{{ old('short_content') }}</textarea>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('medium_content') is-invalid @enderror" name="medium_content" id="medium_content" cols="30" rows="10">{{ old('medium_content') }}</textarea>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('long_content') is-invalid @enderror" name="long_content" id="long_content" cols="30" rows="10">{{ old('long_content') }}</textarea>
