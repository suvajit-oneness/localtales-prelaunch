        ...
        <div class="row w-100">
            ...
            <div class="col-md-9 text-right">
                ...
                <a href="#csvUploadModal" data-toggle="modal" class="btn btn-primary "><i class="fa fa-cloud-upload"></i> CSV
                    Upload</a>
                <a href="{{ route('admin.state.data.csv.export') }}" class="btn btn-primary "><i
                ...
                <form action="{{ route('admin.state.image.upload') }}" enctype="multipart/form-data" id="bulk_image_form"
                    method="POST">
                    @csrf
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row align-items-center justify-content-between">
                <div class="col">
                    <ul>
                        <li class="active">Total Number of States({{ $states->total() }})</span></li>
                        {{-- @php
                ...
                <div class="col-auto">
                    <form action="{{ route('admin.state.index') }}">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <button type="submit" class="btn btn-outline-danger btn-sm">Search State</button>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <tbody>
                                @foreach ($states as $key => $category)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('/admin/uploads/state/images/' . $category->image) }}"
...
=======
                                    ...
                                    <div class="toggle-button-cover margin-auto">
                                        <div class="button-cover">
                                            ...
                                            {{-- <div class="button-togglr b2" id="button-11">
>>>>>>> 27807c045e9aa19e1286390936cb04a584690b87
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group" aria-label="Second group">
                                                <a href="{{ route('admin.state.edit', $category['id']) }}"
                                                    class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                                <a href="{{ route('admin.state.details', $category['id']) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.state.data.csv.store') }}" enctype="multipart/form-data"
                        id="fileCsvUploadForm">
                        @csrf
                        ...
                        <p class="my-2"><a href="{{ URL::to('/') }}/admin/csvexample/state.csv" target="_blank"
                                class="small">
