                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="row__action">
                                    <a href="{{ route('admin.forntendcollection.edit', $item->id) }}">Edit</a>
                                    <a href="{{ route('admin.forntendcollection.details', $item->id) }}">View</a>
                                </div>
                                </td>
     ...
     <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.forntendcollection.updateStatus')}}",
