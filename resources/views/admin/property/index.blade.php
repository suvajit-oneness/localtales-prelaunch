...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.property.create') }}" class="btn btn-primary pull-right">Add New</a>
    </div>
                            ...
                            @foreach($properties as $key => $property)
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.property.edit', $property['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.property.details', $property['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
    ...
    <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.property.updateStatus')}}",
