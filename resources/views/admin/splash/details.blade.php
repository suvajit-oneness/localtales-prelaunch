...
<section>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="text-dark small">{{strtoupper($splash->pretty_name)}}</p>
            ...
            <a class="btn btn-secondary" href="{{ route('admin.splash.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Back</a>
        </div>
