    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="{{ route('admin.bussinesslead.store') }}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name"> Business Name <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('bussiness_name') is-invalid @enderror" type="text" name="bussiness_name" id="name" value="{{ old('bussiness_name') }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('service_description') is-invalid @enderror" type="text" name="service_description" id="service_description">{{ old('service_description') }}</textarea>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('alt_mobile_no') is-invalid @enderror" type="text" name="alt_mobile_no" id="alt_mobile_no" value="{{ old('alt_mobile_no') }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('bussiness_address') is-invalid @enderror" type="text" name="bussiness_address" id="name" value="{{ old('bussiness_address') }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('facebook_link') is-invalid @enderror" type="text" name="facebook_link" id="name" value="{{ old('facebook_link') }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('twitter_link') is-invalid @enderror" type="text" name="twitter_link" id="name" value="{{ old('twitter_link') }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('instagram_link') is-invalid @enderror" type="text" name="instagram_link" id="name" value="{{ old('instagram_link') }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('linkedin_link') is-invalid @enderror" type="text" name="linkedin_link" id="name" value="{{ old('linkedin_link') }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('youtube_link') is-invalid @enderror" type="text" name="youtube_link" id="name" value="{{ old('youtube_link') }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('monday_opening_hour') is-invalid @enderror" type="text" name="monday_opening_hour" id="monday_opening_hour" value="{{ old('monday_opening_hour') }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('tuesday_opening_hour') is-invalid @enderror" type="text" name="tuesday_opening_hour" id="tuesday_opening_hour" value="{{ old('tuesday_opening_hour') }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('wednesday_opening_hour') is-invalid @enderror" type="text" name="wednesday_opening_hour" id="wednesday_opening_hour" value="{{ old('wednesday_opening_hour') }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('thursday_opening_hour') is-invalid @enderror" type="text" name="thursday_opening_hour" id="thursday_opening_hour" value="{{ old('thursday_opening_hour') }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('friday_opening_hour') is-invalid @enderror" type="text" name="friday_opening_hour" id="friday_opening_hour" value="{{ old('friday_opening_hour') }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('saturday_opening_hour') is-invalid @enderror" type="text" name="saturday_opening_hour" id="saturday_opening_hour" value="{{ old('saturday_opening_hour') }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('sunday_opening_hour') is-invalid @enderror" type="text" name="sunday_opening_hour" id="sunday_opening_hour" value="{{ old('sunday_opening_hour') }}"/>
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Business Lead</button>
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('admin.bussinesslead.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
                </form>
