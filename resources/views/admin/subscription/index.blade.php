    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row align-items-center justify-content-between">
                <div class="col">
                    <ul>
                        <li class="active">Total Email Subscribed <span class="count">({{$subscription->total()}})</span></a></li>
                        {{-- @php
                    ...
                    <table class="table table-hover custom-data-table-style table-striped">
                        ...
                        <tbody>
                            @foreach($subscription as $key => $item)
                                <tr>
                                    <td>{{ ($subscription->firstItem()) + $key }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        ...
                                        <a href="{{ route('admin.email-subscription.detail', $item['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
                                    </div>
                                </td>
                                </tr>
                            @endforeach
